...
AIHF_JSON = (LOCAL_DATA_DIR / 'ai-hedge-fund-committee-scan.json') if (LOCAL_DATA_DIR / 'ai-hedge-fund-committee-scan.json').exists() else (REPO_DATA_DIR / 'ai-hedge-fund-committee-scan.json')
AIHF_BLIND_JSON = (LOCAL_DATA_DIR / 'ai-hedge-fund-committee-blind.json') if (LOCAL_DATA_DIR / 'ai-hedge-fund-committee-blind.json').exists() else (REPO_DATA_DIR / 'ai-hedge-fund-committee-blind.json')
AIHF_PORTFOLIO_JSON = (LOCAL_DATA_DIR / 'aihf-paper-portfolio.json') if (LOCAL_DATA_DIR / 'aihf-paper-portfolio.json').exists() else (REPO_DATA_DIR / 'aihf-paper-portfolio.json')
AIHF_ALPACA_STATE_JSON = (LOCAL_DATA_DIR / 'aihf-alpaca-paper-state.json') if (LOCAL_DATA_DIR / 'aihf-alpaca-paper-state.json').exists() else (REPO_DATA_DIR / 'aihf-alpaca-paper-state.json')
